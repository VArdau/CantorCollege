...
$queryDesign = "SELECT * FROM design";
$resultDesign = $mysqli->query( $queryDesign );
?>
...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <div class="par"><p>The College is an internationally connected creative community of diverse disciplines housed under one roof. We shape our students' futures, preparing them to shape the world through applied knowledge and creativity. </p>
    ...
    <table>
        <tr>
          ...
          <?php 
          while ($obj = $resultDesign -> fetch_object()) {
              echo "<tr>";
      ...
      <div class="sidebyside">
        <img src="images/resized/design-one.jpg" class="smallerimg" alt="">
        <img src="images/resized/design-two.jpg" class="smallerimg" alt="">
      </div>
